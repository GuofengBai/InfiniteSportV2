...
function insertUser()
{
    ...
    $names=array("蔡慧康", "王大雷", "曾诚", "于海", "于大宝", "孙世林", "秦升", "邓卓祥", "邵佳一", "蒿俊闵","赵旭日", "冯潇霆", "杨智", "孙可", "武磊", "孙兴慜", "奇诚庸", "李青龙", "郑智", "郑大世","蔡慧康", "王大雷", "曾诚", "于海", "于大宝", "孙世林", "秦升", "邓卓祥", "邵佳一", "蒿俊闵","赵旭日", "冯潇霆", "杨智", "孙可", "武磊", "孙兴慜", "奇诚庸", "李青龙", "郑智", "郑大世","蔡慧康", "王大雷", "曾诚", "于海", "于大宝", "孙世林", "秦升", "邓卓祥", "邵佳一", "蒿俊闵","赵旭日", "冯潇霆", "杨智", "孙可", "武磊", "孙兴慜", "奇诚庸", "李青龙", "郑智", "郑大世","蔡慧康", "王大雷", "曾诚", "于海", "于大宝", "孙世林", "秦升", "邓卓祥", "邵佳一", "蒿俊闵","赵旭日", "冯潇霆", "杨智", "孙可", "武磊", "孙兴慜", "奇诚庸", "李青龙", "郑智", "郑大世","蔡慧康", "王大雷", "曾诚", "于海", "于大宝", "孙世林", "秦升", "邓卓祥", "邵佳一", "蒿俊闵","赵旭日", "冯潇霆", "杨智", "孙可", "武磊", "孙兴慜", "奇诚庸", "李青龙", "郑智", "郑大世" );
    for ($i = 0; $i < 100; $i++) {
        $id = "user".$i;
        $name = $names[$i];
        $password = "123456";
