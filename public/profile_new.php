                    ...
                    <div class="row">
                        <div class="col-sm-4 col-md-12">
                            <div class="user-profile-pic">
                                <img src="images/profile/trump.jpg" alt="">
                        ...
                        <div class="col-sm-6 col-md-12" style="font-size: 1.5rem">
                            <div class="user-name m-top-sm">唐纳德·特朗普<i
                                        ...
                                        <div class="row" style="font-size: 1.5rem">
                                            <div class="col-sm-3 col-sm-6s">
                                                <div class="widget-stat3 bg-danger">
                                                    ...
                                                    <div class="text-center" id="t_calorie">5123</div>
                                                </div>
                                            </div><!-- ./col -->
                                            <div class="col-sm-3 col-sm-6s">
                                                <div class="widget-stat3 bg-warning">
                                                    ...
                                                    <div class="text-center" id="t_steps">5123</div>
                                                </div>
                                            </div><!-- ./col -->
                                            <div class="col-sm-3 col-sms-6">
                                                <div class="widget-stat3 bg-info">
                                                    ...
                                                    <div class="text-center" id="t_miles">5123</div>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 col-sm-6s">
                                                <div class="widget-stat3 bg-primary">
                                                    ...
                                                    <div class="text-center" id="t_days">5123</div>
                                                </div>
                                            </div>
                                        </div><!-- ./row -->
                                                ...
                                                <div class="row m-top-md">
                                                    <div class="col-sm-6">
                                                        <div class="widget-stat3 bg-primary">
                                                            ...
                                                            <div class="text-center" id="a_join">5123</div>
                                                        </div>
                                                    </div><!-- ./col -->
                                                    <div class="col-sm-6">
                                                        <div class="widget-stat3 bg-info">
                                                            ...
                                                            <div class="text-center" id="a_uncomplete">5123</div>
                                                        </div>
                                                    </div><!-- ./col -->
                                                </div>
                                            </div><!-- ./col -->
                                                ...
                                                <div class="row m-top-md">
                                                    <div class="col-sm-6">
                                                        <div class="widget-stat3 bg-primary">
                                                            ...
                                                            <div class="text-center" id="w_number">5123</div>
                                                        </div>
                                                    </div><!-- ./col -->
                                                    <div class="col-sm-6">
                                                        <div class="widget-stat3 bg-info">
                                                            ...
                                                            <div class="text-center" id="w_rank">5123</div>
                                                        </div>
                                                    </div><!-- ./col -->
                                                </div>
